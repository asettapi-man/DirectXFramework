...
void vnDebugDraw::Grid(int num, float interval, DWORD color)
{
	...
	{
		//Z軸
		vtx[VertexNum].x = -num / 2 * interval;	vtx[VertexNum].y = 0.0f;	vtx[VertexNum].z = i * interval;	vtx[VertexNum].color = color;	VertexNum++;
		vtx[VertexNum].x = num / 2 * interval;	vtx[VertexNum].y = 0.0f;	vtx[VertexNum].z = i * interval;	vtx[VertexNum].color = color;	VertexNum++;

		//X軸
		vtx[VertexNum].x = i * interval; vtx[VertexNum].y = 0.0f;	vtx[VertexNum].z = -num / 2 * interval;	vtx[VertexNum].color = color;	VertexNum++;
		vtx[VertexNum].x = i * interval; vtx[VertexNum].y = 0.0f;	vtx[VertexNum].z = num / 2 * interval;	vtx[VertexNum].color = color;	VertexNum++;
	}
}
