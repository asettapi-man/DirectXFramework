...
protected:
	...
	static ID3D12PipelineState		*pPipelineState_T;		//パイプラインステート（半透明有り）
	static ID3D12PipelineState      *pPipelineState_T_NL;	//パイプラインステート（半透明有り・ライティング無し）
